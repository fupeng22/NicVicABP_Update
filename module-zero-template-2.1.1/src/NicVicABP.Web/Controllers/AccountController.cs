...
using NicVicABP.Sessions;
using NicVicABP.Web.Controllers.Results;
using NicVicABP.Web.Models;
using NicVicABP.Web.Models.Account;
...
{
    public class AccountController : NicVicABPControllerBase
    {
