...
{
    public class TaskRepository : NicVicABPRepositoryBase<Task, long>, ITaskRepository
    {
        public TaskRepository(IDbContextProvider<NicVicABPDbContext> dbContextProvider)
